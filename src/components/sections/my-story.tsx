      ...
      <div className="container mx-auto px-4">
        <FadeIn>
          <div className="max-w-3xl mx-auto">
            <h2 className="text-3xl md:text-4xl heading-display mb-8">
              My Story
            </h2>
            <div className="prose prose-gray dark:prose-invert max-w-none space-y-6">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                ...
                sequencers, and experimental instruments while developing a
                solid foundation in computer science.
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed">
                After graduating, I attended CodeWorks — an intensive web
                development bootcamp where I honed my skills in modern
                JavaScript frameworks, full-stack development, and industry best
                practices.
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed">
                I then joined BX as a Software Engineer, where I spent four
